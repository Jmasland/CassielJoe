        ...
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-3 overflow-hidden">
            ...
            <ul className="list-unstyled text-white ps-0">
              ...
              <li className="wow fadeInUp animated" data-wow-duration="1000ms" data-wow-delay="1000ms"><FaAngleRight /><a href="about">Builder Partner </a></li>
              <li className="wow fadeInUp animated" data-wow-duration="1000ms" data-wow-delay="1200ms"><FaAngleRight /><a href="about">Trailer Variety</a></li>
              <li className="wow fadeInUp animated" data-wow-duration="1000ms" data-wow-delay="1400ms"><FaAngleRight /><a href="about">Contact Us</a></li>
            </ul>
          </div>
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-4 col-xl-3 overflow-hidden">
